...
contract PasscardForMVBSeason is ERC721, ReentrancyGuard, Ownable {
    string public constant TOKEN_URI = "ipfs://QmY47RnqPjpneDnmkm2qfaFfwZGTFHvgYHLSbmTroZXRAu";
    ...
    constructor() ERC721("PasscardForMVBSeason", "MVB8") Ownable(msg.sender) {}
